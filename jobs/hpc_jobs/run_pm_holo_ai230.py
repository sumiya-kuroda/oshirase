...
CONFIG_PATH = "/ceph/mrsic_flogel/public/projects/SuKu_20250111_FeedbackRF/configPhotonMosaicVisualInference_holo_ai230.yaml"

PM_CHECK = SuccessCheck(
    stream="stderr",
    success_pattern="successfully",
    success_message="✅ photon-mosaic (holo ai230) job {job_id} completed successfully!",
    failure_message="❌ photon-mosaic (holo ai230) job {job_id} failed. Check the log",
)
